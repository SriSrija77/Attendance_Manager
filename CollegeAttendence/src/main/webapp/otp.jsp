...
<form action="ChangePsw.jsp" method="post" style="font-weight:bold;margin:30px 20px 30px 20px">
<table align="center">

<span><a href="ChangePsw.jsp" style="padding:0px 0px 0px 10px;float:right;"><strong>&times;</strong></a></span>
<%
