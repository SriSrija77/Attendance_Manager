...
<form action="StudentChangePsw.jsp" method="post" style="font-weight:bold;margin:30px 20px 30px 20px">
<table align="center">

<span><a href="StudentChangePsw.jsp" style="padding:0px 0px 0px 10px;float:right;"><strong>&times;</strong></a></span>
<%
if(session.getAttribute("errorMessage")!=null)
out.println("<h1>"+session.getAttribute("errorMessage")+"</h1>");
session.removeAttribute("errorMessage");
%>
<caption><h3>Enter OTP</h3></caption>
<tr>
  <div class="container">
   <td>
